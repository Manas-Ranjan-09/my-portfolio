...
const services = [
  {
    ...
    icon: <FileCode size={24} className="text-[var(--brand-gold)]" />
  },
  {
    id: 2,
    ...
    icon: <Server size={24} className="text-[var(--brand-gold)]" />
  },
  {
    id: 3,
    ...
    icon: <Layout size={24} className="text-[var(--brand-gold)]" />
  },
  {
    id: 4,
    ...
    icon: <Link2 size={24} className="text-[var(--brand-gold)]" />
  },
  {
    id: 5,
    ...
    icon: <Database size={24} className="text-[var(--brand-gold)]" />
  },
  {
    id: 6,
    ...
    icon: <Smartphone size={24} className="text-[var(--brand-gold)]" />
  }
];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              whileHover={{ y: -5 }}
              className="glass-card rounded-2xl p-6 flex flex-col justify-between h-full hover:shadow-[0_12px_35px_rgba(0,0,0,0.5)] transition-all"
            >
              <div>
                {/* Icon wrapper */}
                <div className="p-3 bg-white/5 border border-white/10 rounded-xl w-fit mb-6">
                  {service.icon}
                </div>
